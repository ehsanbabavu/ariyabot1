  ...
  constructor() {
    try {
      this.openai = new OpenAI({
        baseURL: 'https://ai.liara.ir/api/68e204eb1008fc6ccd20c83d/v1',
        apiKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJrZXkiOiI2OGUzOTAzY2I1NTg3Mzk3MWUwMzJjOTYiLCJ0eXBlIjoiYWlfa2V5IiwiaWF0IjoxNzU5NzQ0MDYwfQ.0fV1cefkDyE-q9DZjoPepnidBIM7eFWU4wZHK0nzPDw',
      });
      console.log("🤖 سرویس OpenAI با موفقیت راه‌اندازی شد");
    } catch (error) {
      console.error("❌ خطا در راه‌اندازی OpenAI:", error);
      throw error;
    }
  }
...
- بدون توضیحات اضافی باشد`;
      ...
      console.error("❌ خطا در تولید پاسخ OpenAI:", error);
